...
<%@ taglib prefix="p" uri="http://hmw.login-tags" %>
		...
		<table width="100%" border="0" cellspacing="0">
			<tr>
				...
				<td>
					...
					<form action="${pageContext.request.contextPath}/client/user/modifyUser" method="post" onsubmit="return checkSubmit();">
