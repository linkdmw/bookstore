...
<div id="divmenu">
		...
		<a href="${pageContext.request.contextPath}/client/product/findProductByCategory" style="color:#FFFF00">全部商品目录</a>
	...
	<table width="100%" border="0" cellspacing="0">
		<tr>
			<td style="text-align:right; padding-right:220px">
				Search 
				<input type="text" name="productName" class="inputtable" id="textfield" value="${productName==null?'请输入书名':productName}"
