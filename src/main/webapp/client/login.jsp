															...
															<table width="80%" border="0" cellspacing="0"
																...
																<tr>
																	...
																	<td style="text-align:left"><input name="username"
																		type="text" value="${cookie.bookstore_username.value}" class="textinput" />
																	</td>
																</tr>
																<tr>
																...
																<tr>
																	<td colspan="2" style="text-align:center"><input
																		type="checkbox" checked="checked" name="remember" value="1" />
																		记住用户名&nbsp;&nbsp; <input type="checkbox"
																		name="auto_login" checked="checked" value="1" /> 自动登录</td>
																</tr>
																<tr>
																	<td colspan="2"
