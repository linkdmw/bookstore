...
<%@taglib prefix="p" uri="http://hmw.pager-tags" %>
		...
		<table width="100%" border="0" cellspacing="0">
			<tr>
				<td><div style="text-align:right; margin:5px 10px 5px 0px">
						...
						${category==null?'全部类别':category}&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;&nbsp;图书列表
					</div>
					<table cellspacing="0" class="listcontent">
						<tr>
							<td>
								...
								</h1>&nbsp;&nbsp;&nbsp;&nbsp;共${pageModel.recordCount}种商品
								<hr />
...
<%--													</p>--%>
<%--												</div>--%>
<%--&lt;%&ndash;												<div class="divlisttitle">&ndash;%&gt;--%>
<%--&lt;%&ndash;													<a href="${pageContext.request.contextPath}/findProductById?id=${p.id}">书名：时空穿行 <br />售价：￥38.8 </a>&ndash;%&gt;--%>
<%--&lt;%&ndash;												</div>&ndash;%&gt;--%>
<%--											</td>--%>
								...
								<div class="pagination">
									<p:pager pageIndex="${pageModel.pageIndex}"
