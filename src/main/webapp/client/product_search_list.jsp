...
<%@taglib prefix="page" uri="http://hmw.pager-tags" %>
							...
							<td>
								...
								<div class="pagination">
									<page:pager pageIndex="${pageModel.pageIndex}"
											 ...
											 submitUrl="${pageContext.request.contextPath}/client/product/findProductByName?pageIndex={0}&productName=${productName}"
									/>
<%--									<ul>--%>
